...
Best suited for conceptual questions ("what is X?", "how does Y work?") or research queries. For real-time or current information, it prioritizes web search over local RAG. Completely independent of DSpace, MinIO, Filesystem, Bots, and OpenAlex.
