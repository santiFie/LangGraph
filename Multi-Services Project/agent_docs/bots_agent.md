...
This agent is read-only and completely independent from DSpace, MinIO, filesystem, and OpenAlex. It cannot modify the bot database, only consult and report on IP statuses.
